...
| --- | --- | ---: | ---: | ---: | ---: |
| [Apple (AAPL)](<../strategies/mag7/Apple (AAPL) Confirmation - experimental.thinkscript>) | Stronger entry | 55 / 50 | -$3.09 | -$2.66 | +$0.43 |
| [Microsoft (MSFT)](<../strategies/mag7/Microsoft (MSFT) Confirmation - experimental.thinkscript>) | Baseline | 50 / 50 | +$4.25 | +$4.25 | $0.00 |
| [Alphabet (GOOGL)](<../strategies/mag7/Alphabet (GOOGL) Confirmation - experimental.thinkscript>) | Stronger entry | 55 / 50 | +$0.63 | +$0.96 | +$0.34 |
| [Amazon (AMZN)](<../strategies/mag7/Amazon (AMZN) Confirmation - experimental.thinkscript>) | Original | 50 / 45 | -$1.36 | -$0.49 | +$0.87 |
| [NVIDIA (NVDA)](<../strategies/mag7/NVIDIA (NVDA) Confirmation - experimental.thinkscript>) | Original | 50 / 45 | +$4.31 | +$5.31 | +$1.01 |
| [Meta (META)](<../strategies/mag7/Meta (META) Confirmation - experimental.thinkscript>) | Original | 50 / 45 | -$2.11 | -$2.02 | +$0.09 |
| [Tesla (TSLA)](<../strategies/mag7/Tesla (TSLA) Confirmation - experimental.thinkscript>) | Stronger entry | 55 / 50 | -$1.37 | -$0.16 | +$1.21 |
...
```powershell
pwsh -NoProfile -File research/mag7-2026-09-06/tools/audit-and-select.ps1 -Directory artifacts/mag7-research
pwsh -NoProfile -File research/mag7-2026-09-06/tools/audit-selected.ps1 -Directory artifacts/mag7-research -FrozenSelection research/mag7-2026-09-06/frozen-selection.json
```
