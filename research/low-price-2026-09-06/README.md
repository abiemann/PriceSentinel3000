...
| --- | --- | --- | ---: |
| Nu Holdings / NU | [Nu Holdings (NU) Breakout](<scripts/Nu Holdings (NU) Breakout - experimental.thinkscript>) | B1: prior-channel breakout | 84 |
| SoFi Technologies / SOFI | [SoFi Technologies (SOFI) Breakout](<scripts/SoFi Technologies (SOFI) Breakout - experimental.thinkscript>) | B1: prior-channel breakout | 84 |
| American Airlines / AAL | [American Airlines (AAL) Confirmation](<scripts/American Airlines (AAL) Confirmation - experimental.thinkscript>) | C1: trend-pullback confirmation | 85 |
...
[audit reproduction instructions](tools/AUDIT-README.md).
