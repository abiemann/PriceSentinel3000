...
manifest_path = ROOT / "archive/research/low-price-2026-09-06/candidates/manifest.json"
...
output = ROOT / "artifacts/low-price-research/export-validation"
output.mkdir(parents=True, exist_ok=True)
(output / "indicator-negative-results.json").write_text(json.dumps(dict(appCalls=0, cases=results), indent=2) + "\n", encoding="utf-8")
