...
```powershell
& 'C:\Users\abiem\.cache\codex-runtimes\codex-primary-runtime\dependencies\python\python.exe' research/tools/low-price/test_audit.py
& 'C:\Users\abiem\.cache\codex-runtimes\codex-primary-runtime\dependencies\python\python.exe' research/tools/low-price/audit.py artifacts/low-price-research/development --output artifacts/low-price-research/audit-current
```
