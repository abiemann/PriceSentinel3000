...
& $python research/tools/semiconductors/audit.py artifacts/semiconductor-research/development --output artifacts/semiconductor-research/audit-development
& $python research/tools/low-price/audit-indicators.py --directory artifacts/semiconductor-research/development --manifest archive/research/semiconductors-2026-09-06/candidates/manifest.json --output artifacts/semiconductor-research/audit-development/indicators.json
```
...
```powershell
& $python research/tools/semiconductors/audit.py artifacts/semiconductor-research/development --output artifacts/semiconductor-research/audit-final --include-friday --frozen-selection archive/research/semiconductors-2026-09-06/frozen-selection.json
```
...
Run synthetic adapter tests with `python -m unittest discover -s research/tools/semiconductors -p test_audit.py -v`. These tests do not access market data or the running application.
