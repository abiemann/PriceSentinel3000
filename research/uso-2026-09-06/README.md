...
[United States Oil Fund (USO) Confirmation - experimental](<scripts/United States Oil Fund (USO) Confirmation - experimental.thinkscript>)
...
and [reproduction commands](tools/README.md). Exact raw MCP exports remain local
