...
& $python research/uso-2026-09-06/tools/audit.py artifacts/uso-research/development --output artifacts/uso-research/audit-development
& $python research/low-price-2026-09-06/tools/audit-indicators.py --directory artifacts/uso-research/development --manifest research/uso-2026-09-06/candidates/manifest.json --output artifacts/uso-research/audit-development/indicators.json
```
...
```powershell
& $python research/uso-2026-09-06/tools/audit.py artifacts/uso-research/development --output artifacts/uso-research/audit-final --include-friday --frozen-selection research/uso-2026-09-06/frozen-selection.json
& $python research/low-price-2026-09-06/tools/audit-indicators.py --directory artifacts/uso-research/development --manifest research/uso-2026-09-06/candidates/manifest.json --output artifacts/uso-research/audit-final/indicators.json
```
...
Run the adapter's synthetic selection and corruption tests with `python -m unittest discover -s research/uso-2026-09-06/tools -p test_audit.py -v`. The original low-price audit tests remain available separately for the shared ledger implementation.
