...
| --- | --- | --- | ---: |
| SOXL | [Direxion Semiconductor Bull 3X (SOXL) Mean Recovery - experimental](<scripts/Direxion Semiconductor Bull 3X (SOXL) Mean Recovery - experimental.thinkscript>) | R1, selected among five frozen hypotheses | 51 bars |
| SOXX | [iShares Semiconductor (SOXX) Confirmation - experimental](<scripts/iShares Semiconductor (SOXX) Confirmation - experimental.thinkscript>) | Unvalidated C1 starter; no winner | 85 bars |
...
and [reproduction instructions](tools/README.md).
