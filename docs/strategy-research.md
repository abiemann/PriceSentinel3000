...
[research-sources.json](../samples/strategies/research-sources.json).
...
[OriginalConfirmation.thinkscript](../samples/strategies/OriginalConfirmation.thinkscript)
...
[compatibility-results.json](../samples/strategies/compatibility-results.json)
contains the measured results, source hashes, diagnostics, and exact run time.

The standalone [validation project](../samples/strategies/validation/StrategyExamples.csproj)
references the Core interpreter and reads
[validation-fixtures.json](../samples/strategies/validation-fixtures.json). It has
...
```powershell
dotnet run --project samples/strategies/validation/StrategyExamples.csproj
```

To also check the recorded third-party copies retained on this machine:

```powershell
dotnet run --project samples/strategies/validation/StrategyExamples.csproj -- "D:\Projects\PriceSentinel3000-script-research"
```
